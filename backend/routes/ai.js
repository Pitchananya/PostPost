...
[{"kind":"tip","th":"หัวข้อภาษาไทย","en":"English topic","len_th":"80-120 คำ","len_en":"80-120 words","f":"F1"}, ...]`;
  ...
  try {
    ...
    const text = await callOpenRouter([{ role: 'user', content: userMsg }], system, { max_tokens: tokenBudget, model: textModel || undefined });
...
{"hooks":[{"text":"...","angle":"..."},{"text":"...","angle":"..."},{"text":"...","angle":"..."}],"caption":"...","hashtags":["#...","#..."],"article":"...","imagePrompts":[${Array(nImg).fill('"..."').join(',')}]}`;
  ...
  try {
    const text = await callOpenRouter([{ role: 'user', content: userMsg }], system, { max_tokens: 3200 + nImg * 220, model: textModel || undefined });
