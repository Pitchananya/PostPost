...
const DEFAULTS = {
  ...
  imageModel: 'openai/gpt-5.4-image-2',                   // default image model — one of two REAL OpenRouter image-output ids (the other is google/gemini-3.1-flash-image-preview). All other previously-listed ids were rewritten in creative.js's LEGACY map.
